...
class AccessibilityNodeInfoDumper {
	...
	private static final String LOGTAG = AccessibilityNodeInfoDumper.class
			.getSimpleName();
	...
	public static List<Node> dumpNodes(UiDevice device) {
		List<Node> nodes = new ArrayList<Node>();
		for (AccessibilityNodeInfo root : device.getWindowRoots()) {
			Node node = new Node();
			dumpNode(root, node, 0, device.getDisplayWidth(),
