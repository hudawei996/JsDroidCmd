...
public class Dim {
	...
	public String[] functionNames() {
		synchronized (urlToSourceInfo) {
			return functionNames.keySet().toArray(
					new String[functionNames.size()]);
		}
	}
	...
	public static class StackFrame implements DebugFrame {
		 ...
		 */
		public void onEnter(Context cx, String sourceName, Scriptable scope,
		 ...
		 */
		public void onLineChange(Context cx,String sourceName, int lineno) {
	...
	public static class SourceInfo {
		...
		private SourceInfo(String source, DebuggableScript[] functions,
			...
			for (int i = 0; i != N; ++i) {
				...
				this.functionSources[i] = new FunctionSource(this,
						firstLines[i], name);
			}
		}
