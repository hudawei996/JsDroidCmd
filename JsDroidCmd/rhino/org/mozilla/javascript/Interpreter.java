...
import com.jsdroid.core.JsStopException;
...
public final class Interpreter extends Icode implements Evaluator {
		...
		StateLoop: for (;;) {
			withoutExceptions: try {
				...
				Loop: for (;;) {
					// stop flag
					if (QUIT) {
						throw new JsStopException("script stop.");
					}
					...
					jumplessRun: {
						...
						case Token.ENUM_INIT_VALUES_IN_ORDER: {
							...
							int enumType = op == Token.ENUM_INIT_KEYS ? ScriptRuntime.ENUMERATE_KEYS
									: op == Token.ENUM_INIT_VALUES ? ScriptRuntime.ENUMERATE_VALUES
											: op == Token.ENUM_INIT_VALUES_IN_ORDER ? ScriptRuntime.ENUMERATE_VALUES_IN_ORDER
						...
						case Icode_LINE:
							...
							if (frame.debuggerFrame != null) {
								...
								frame.debuggerFrame.onLineChange(cx,
										frame.fnOrScript.idata.getSourceName(),
										line);
							}
							frame.pc += 2;
							continue Loop;
	...
	private static Object freezeGenerator(Context cx, CallFrame frame,
		...
		return (frame.result != DOUBLE_MARK) ? frame.result : ScriptRuntime
	...
	private static void enterFrame(Context cx, CallFrame frame, Object[] args,
		...
		if (usesActivation || isDebugged) {
			...
			if (isDebugged) {
				frame.debuggerFrame.onEnter(cx,
						"" + frame.fnOrScript.idata.getSourceName(), scope,
						frame.thisObj, args);
			}
